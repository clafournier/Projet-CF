...
volatilité_DATA = volatilité.history(period='5d', interval = "1m")
volatilité_DATA2 = volatilité.history(period='1d', start=start_date, end=end_date)
diff_volatilité = volatilité_DATA2.Close[-2] - volatilité_DATA2.Close[-3]
r_volatilité = diff_volatilité/volatilité_DATA2.Close[-3]
...
tickerDf1 = tickerData1.history(period='1d', start=start_date, end=end_date) # Obtenir l'hitorique des cours pour ce ticker
...
plt.rcdefaults()                          # Récupérer le style par défault
plt.grid('all')                            # J,ai plus de grid ???
plt.legend ()                             # J'ai pas de légende (seulement un petit point noir ???)
...
if selection == '5 jours':
    ...
    ax4.plot(tickerDf4.Close[-5:-1], color = 'blue')
    ...
    ax4.plot(tickerDf4.Close[-30:-1], color = 'black')
    ...
    ax4.plot(tickerDf4.Close[-180:-1], color = 'blue')


elif selection == '1 an':
    ax1.plot(tickerDf1.Close[-22:-1], color = 'cyan')
    ax2.plot(tickerDf2.Close[-22:-1], color = 'black')
    ax3.plot(tickerDf3.Close[-22:-1], color = 'blue')
    ax4.plot(tickerDf4.Close[-22:-1], color = 'red')


elif selection == '3 ans':
    ax1.plot(tickerDf1.Close[-3*252:-1], color = 'red')
    ax2.plot(tickerDf2.Close[-3*252:-1], color = 'cyan')
    ax3.plot(tickerDf3.Close[-3*252:-1], color = 'black')
    ax4.plot(tickerDf4.Close[-3*252:-1], color = 'blue')

elif selection == '5 ans':
    ax1.plot(tickerDf1.Close[-5*252:-1], color = 'cyan')
    ax2.plot(tickerDf2.Close[-5*252:-1], color = 'red')
    ax3.plot(tickerDf3.Close[-5*252:-1], color = 'black')
    ax4.plot(tickerDf4.Close[-5*252:-1], color = 'blue')
    ...
    ax4.plot(tickerDf4.Close[-10*252:-1], color = 'red')
